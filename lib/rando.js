...
(function() {
  var ADJECTIVE, CONJUNCTION, NOUN, PATTERN_MAP, Rando, VERB, createGenerator;
  ...
  PATTERN_MAP = [[NOUN, NOUN], [ADJECTIVE, NOUN], [ADJECTIVE, NOUN, NOUN], [ADJECTIVE, ADJECTIVE, NOUN], [VERB, CONJUNCTION, ADJECTIVE, NOUN], [ADJECTIVE, ADJECTIVE, NOUN, NOUN], [CONJUNCTION, ADJECTIVE, NOUN]];
  ...
  Rando = (function() {
    ...
    Rando.prototype._randomPattern = function() {
      var randomInt;
      randomInt = this._randomInt(0, PATTERN_MAP.length - 1);
